...
<html lang="es">
  <head>
    ...
    <title>SOS Gestión - Incidencias</title>
  </head>
  <body>
            ...
            <div class="col-md-8 offset-md-2 al-centro">
              <form action="#" method="post" accept-charset="utf-8">
                <div class="form-group">  <!-- buscar -->
                   ...
                   <form action="#" method="post" accept-charset="utf-8">
                      <div class="form-group">  <!-- buscar -->
                        <div class="input-group buscar-grupo bs-alto">
                    ...
                    <a class="btn btn-info separa-bt bt-inc-ad" href="admin-panel.php" title="volver a panel de administración"><!-- atras -->
                                    ...
                                    if ($tra_nom) {
                                      ...
                                      while ($fila_tra = mysqli_fetch_array($tra_nom,MYSQLI_ASSOC)) {
                                        ...
                                        if ($fila['estado'] == 'Solventada') {
                                          ...
                                          echo "<td><button type='button' class='btn btn-success bt-solv-in' data-toggle='modal' data-target='#$fila[id]estado'>$fila[estado] <i class='fas fa-exclamation-circle'></i></i></button></td></tr>";

                                        } else {

                                          echo "<td><button type='button' class='btn btn-danger bt-solv-in' data-toggle='modal' data-target='#$fila[id]estado'>$fila[estado] <i class='fas fa-exclamation-circle'></i></i></button></td></tr>";
                ...
                <div class="row">
                  <div class="col-md-2 offset-md-6"> <!-- col paginacion productos -->
                        <nav aria-label="Page navigation example">
                          <ul class="pagination pag-inc-ad">
                            <?php
