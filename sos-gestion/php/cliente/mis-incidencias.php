    ...
    <div class="container-fluid bg-panel seccion"> <!-- container fluid sup -->
        ...
        <div class="container pos-container"> <!-- container -->
          <div class="row">
            ...
            <a class="btn btn-success separa-bt bot-ir-adp" href="informe-incidencias.php" title="Ver informe de incidencias"><!-- atras -->
          ...
          <div class="row">
            <div class="col-md-6 offset-md-3">
                <p align="center" class="ayuda "><i class="fas fa-info-circle"></i><b> Se muestran las incidencias ocurridas en el último mes</b></p>
            </div>
            <div class="col-md-10 offset-md-1 ">
              <?php
                  $conexion = abrirConexion();
                  $sql_lista = "SELECT * FROM incidencia WHERE id_cliente='$_SESSION[id]' AND fecha BETWEEN date_sub(now(), interval 1 month)  AND NOW() ORDER BY id DESC";
                  ...
                  if ($query) { // query
                    ...
                    $sql_incidencias = "SELECT * FROM incidencia WHERE id_cliente='$_SESSION[id]' AND fecha BETWEEN date_sub(now(), interval 1 month)  AND NOW() ORDER BY id DESC LIMIT $inicio,$paginacion";
